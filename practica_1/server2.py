...
SIGUIENTE_NODO = "https://vocally-envelope-unharmed.ngrok-free.dev/recibir" 
...
def iniciar():
    # Salida desde el User 1
    payload_inicial = {"valor": 0, "name": MI_NOMBRE}
    threading.Thread(target=enviar_al_siguiente, args=(payload_inicial,)).start()
    return jsonify({"status": "Algoritmo inicializado"}), 200
